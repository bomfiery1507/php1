...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo(base_url())?>vendor/carou.css">
    <script type="text/javascript" src="<?php echo(base_url()) ?>vendor/ca.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo(base_url())?>vendor/loz.css">
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">iPhone Xsmax 64GB</li>
  </ol>
</nav>
	</div>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
             <img src="<?php echo(base_url()) ?>Pic/xs64.jpg">
             <h3>iPhone Xsmax 64GB</h3>
    </div>
			...
			<div class="col-md-6">
				<div class="container">
					<h2 style="margin-top:50px ">29.990.000 VNĐ</h2>
				</div>
				<div class="container">
					<h3>Thông số: </h3><br>
					<p>Màn hình: 5.8 inch <br>
					Camera trước :	MP <br>
						Camera sau :	12MP <br>
						Ram : 4G<br>
